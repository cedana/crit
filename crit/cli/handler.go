...
import (
	...
	"github.com/cedana/go-criu/v7/crit/images/apparmor"
	"github.com/cedana/go-criu/v7/crit/images/autofs"
	binfmt_misc "github.com/cedana/go-criu/v7/crit/images/binfmt-misc"
	...
	"github.com/cedana/go-criu/v7/crit/images/cgroup"
	"github.com/cedana/go-criu/v7/crit/images/cpuinfo"
	"github.com/cedana/go-criu/v7/crit/images/creds"
	criu_core "github.com/cedana/go-criu/v7/crit/images/criu-core"
	criu_sa "github.com/cedana/go-criu/v7/crit/images/criu-sa"
	"github.com/cedana/go-criu/v7/crit/images/eventfd"
	"github.com/cedana/go-criu/v7/crit/images/eventpoll"
	ext_file "github.com/cedana/go-criu/v7/crit/images/ext-file"
	"github.com/cedana/go-criu/v7/crit/images/fdinfo"
	"github.com/cedana/go-criu/v7/crit/images/fh"
	"github.com/cedana/go-criu/v7/crit/images/fifo"
	file_lock "github.com/cedana/go-criu/v7/crit/images/file-lock"
	"github.com/cedana/go-criu/v7/crit/images/fs"
	"github.com/cedana/go-criu/v7/crit/images/fsnotify"
	"github.com/cedana/go-criu/v7/crit/images/inventory"
	ipc_msg "github.com/cedana/go-criu/v7/crit/images/ipc-msg"
	ipc_sem "github.com/cedana/go-criu/v7/crit/images/ipc-sem"
	ipc_shm "github.com/cedana/go-criu/v7/crit/images/ipc-shm"
	ipc_var "github.com/cedana/go-criu/v7/crit/images/ipc-var"
	"github.com/cedana/go-criu/v7/crit/images/memfd"
	"github.com/cedana/go-criu/v7/crit/images/mm"
	"github.com/cedana/go-criu/v7/crit/images/mnt"
	"github.com/cedana/go-criu/v7/crit/images/netdev"
	"github.com/cedana/go-criu/v7/crit/images/ns"
	packet_sock "github.com/cedana/go-criu/v7/crit/images/packet-sock"
	"github.com/cedana/go-criu/v7/crit/images/pidns"
	"github.com/cedana/go-criu/v7/crit/images/pipe"
	...
	remap_file_path "github.com/cedana/go-criu/v7/crit/images/remap-file-path"
	"github.com/cedana/go-criu/v7/crit/images/rlimit"
	"github.com/cedana/go-criu/v7/crit/images/seccomp"
	"github.com/cedana/go-criu/v7/crit/images/signalfd"
	...
	"github.com/cedana/go-criu/v7/crit/images/timens"
	"github.com/cedana/go-criu/v7/crit/images/timer"
	"github.com/cedana/go-criu/v7/crit/images/timerfd"
	"github.com/cedana/go-criu/v7/crit/images/tty"
	"github.com/cedana/go-criu/v7/crit/images/tun"
	"github.com/cedana/go-criu/v7/crit/images/userns"
	"github.com/cedana/go-criu/v7/crit/images/utsns"
	"github.com/cedana/go-criu/v7/crit/images/vma"
