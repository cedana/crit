...
const file_core_s390_proto_rawDesc = "" +
	...
	"\x0eclear_tid_addr\x18\x01 \x02(\x04B\x05\x92~\x02\b\x01R\fclearTidAddr\x124\n" +
	"\x06gpregs\x18\x02 \x02(\v2\x15.user_s390_regs_entryB\x05\x92~\x02\b\x01R\x06gpregs\x126\n" +
	"\x06fpregs\x18\x03 \x02(\v2\x17.user_s390_fpregs_entryB\x05\x92~\x02\b\x01R\x06fpregs\x12;\n" +
	"\bvxrs_low\x18\x04 \x01(\v2\x19.user_s390_vxrs_low_entryB\x05\x92~\x02\b\x01R\avxrsLow\x12>\n" +
	"\tvxrs_high\x18\x05 \x01(\v2\x1a.user_s390_vxrs_high_entryB\x05\x92~\x02\b\x01R\bvxrsHigh\x122\n" +
	"\x05gs_cb\x18\x06 \x01(\v2\x16.user_s390_gs_cb_entryB\x05\x92~\x02\b\x01R\x04gsCb\x122\n" +
	"\x05gs_bc\x18\a \x01(\v2\x16.user_s390_gs_cb_entryB\x05\x92~\x02\b\x01R\x04gsBc\x12/\n" +
	"\x05ri_cb\x18\b \x01(\v2\x13.user_s390_ri_entryB\x05\x92~\x02\b\x01R\x04riCb"
