...
import (
	...
	vma "github.com/cedana/go-criu/v7/crit/images/vma"
...
const file_mm_proto_rawDesc = "" +
	...
	"\bmm_entry\x12)\n" +
	"\rmm_start_code\x18\x01 \x02(\x04B\x05\x92~\x02\b\x01R\vmmStartCode\x12%\n" +
	"\vmm_end_code\x18\x02 \x02(\x04B\x05\x92~\x02\b\x01R\tmmEndCode\x12)\n" +
	"\rmm_start_data\x18\x03 \x02(\x04B\x05\x92~\x02\b\x01R\vmmStartData\x12%\n" +
	"\vmm_end_data\x18\x04 \x02(\x04B\x05\x92~\x02\b\x01R\tmmEndData\x12+\n" +
	"\x0emm_start_stack\x18\x05 \x02(\x04B\x05\x92~\x02\b\x01R\fmmStartStack\x12'\n" +
	"\fmm_start_brk\x18\x06 \x02(\x04B\x05\x92~\x02\b\x01R\n" +
	"mmStartBrk\x12\x1c\n" +
	"\x06mm_brk\x18\a \x02(\x04B\x05\x92~\x02\b\x01R\x05mmBrk\x12'\n" +
	"\fmm_arg_start\x18\b \x02(\x04B\x05\x92~\x02\b\x01R\n" +
	"mmArgStart\x12#\n" +
	"\n" +
	"mm_arg_end\x18\t \x02(\x04B\x05\x92~\x02\b\x01R\bmmArgEnd\x12'\n" +
	"\fmm_env_start\x18\n" +
	" \x02(\x04B\x05\x92~\x02\b\x01R\n" +
	"mmEnvStart\x12#\n" +
	"\n" +
	"mm_env_end\x18\v \x02(\x04B\x05\x92~\x02\b\x01R\bmmEnvEnd\x12\x1e\n" +
