...
const file_sk_unix_proto_rawDesc = "" +
	...
	"\x04type\x18\x03 \x02(\rB\a\x92~\x042\x02skR\x04type\x12\x1d\n" +
	"\x05state\x18\x04 \x02(\rB\a\x92~\x042\x02skR\x05state\x12\x1b\n" +
	"\x05flags\x18\x05 \x02(\rB\x05\x92~\x02\b\x01R\x05flags\x12\x1d\n" +
	"\x06uflags\x18\x06 \x02(\rB\x05\x92~\x02\b\x01R\x06uflags\x12\x18\n" +
	...
	"\x04name\x18\v \x02(\fB\x0e\x92~\v:\tunix_nameR\x04name\x12(\n" +
