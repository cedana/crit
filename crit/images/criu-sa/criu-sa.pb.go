...
const file_criu_sa_proto_rawDesc = "" +
	...
	"opts.proto\"\xe1\x01\n" +
	"\bsa_entry\x12#\n" +
	"\tsigaction\x18\x01 \x02(\x04B\x05\x92~\x02\b\x01R\tsigaction\x12\x1b\n" +
	"\x05flags\x18\x02 \x02(\x04B\x05\x92~\x02\b\x01R\x05flags\x12!\n" +
	"\brestorer\x18\x03 \x02(\x04B\x05\x92~\x02\b\x01R\brestorer\x12\x19\n" +
	"\x04mask\x18\x04 \x02(\x04B\x05\x92~\x02\b\x01R\x04mask\x12)\n" +
	"\x10compat_sigaction\x18\x05 \x01(\bR\x0fcompatSigaction\x12*\n" +
	"\rmask_extended\x18\x06 \x01(\x04B\x05\x92~\x02\b\x01R\fmaskExtended"
