...
const file_mnt_proto_rawDesc = "" +
	...
	"\broot_dev\x18\x03 \x02(\rB\x05\x92~\x02 \x01R\arootDev\x12\"\n" +
	"\rparent_mnt_id\x18\x04 \x02(\rR\vparentMntId\x12\x1b\n" +
	"\x05flags\x18\x05 \x02(\rB\x05\x92~\x02\b\x01R\x05flags\x12\x12\n" +
	...
	"\bsb_flags\x18\x11 \x01(\rB\x05\x92~\x02\b\x01R\asbFlags\x12\x17\n" +
